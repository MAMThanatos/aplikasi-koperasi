 ...
 * @author wtf
 */
public class PanelActionAdmin extends javax.swing.JPanel {

    /**
     * Creates new form PanelAction
     */
    public PanelActionAdmin() {
        initComponents();
    }
    
    public void initEvent(TableActionEventAdmin ev, int row) {
    ...
    public void setStatus(String status) {
        if ("Ditolak".equalsIgnoreCase(status) || "Lunas".equalsIgnoreCase(status) || "Dibatalkan".equalsIgnoreCase(status)) {
